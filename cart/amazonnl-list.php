...
<div class="gcheader">Amazon NL Giftcards</div>
<div id="product-grid">
...
INNER JOIN sell_order ON giftcard.id = sell_order.giftcard_id) WHERE giftcard.brand = 'Amazon NL' AND giftcard.verified = 1 AND giftcard.sold = 0";
